...
const UI = {
  ...
  successBg: "rgba(44, 201, 182, 0.12)",
  radius: 12,
  inputH: 36,
  gap: 12,
};
...
const Option = (props) => (
  <components.Option {...props}>
    <div style={{ display: "flex", alignItems: "center" }}>
      ...
      <span>
        +{props.data.dial} — {props.data.name}
      </span>
    </div>
  </components.Option>
);
...
function ProfileInfo({
  ...
  const getVisibility = (field) =>
    profileForm?.visibility?.[field] ||
    userData?.visibility?.[field] ||
    "public";

  const isHiddenFromViewer = (field) =>
    getVisibility(field) === "private" && !canEdit;
  ...
  const togglePrivacy = (field) =>
    setProfileForm({
      ...
      visibility: {
        ...
        [field]:
          getVisibility(field) === "private" ? "public" : "private",
      },
    });

  /* Phone */
  const phoneCountry =
    profileForm.phoneCountry || userData?.phoneCountry || "US";
  const phoneNumber =
  ...
  const setPhoneCountry = (iso2) =>
    setProfileForm({ ...profileForm, phoneCountry: iso2 });
  ...
  /* UI helpers */
  const labelStyle = { color: UI.text, fontWeight: 700, fontSize: 13 };
  const chip = (field) => {
    const isPrivate = getVisibility(field) === "private";
    return (
      <button
        type="button"
        ...
        style={{
          ...
          background: isPrivate ? UI.dangerBg : UI.successBg,
          color: isPrivate ? "#ff9c9c" : UI.accent,
          cursor: "pointer",
        }}
      >
  ...
  const FieldRow = ({
    ...
    return (
      <div style={{ marginBottom: UI.gap + 4 }}>
        <div style={{ display: "flex", alignItems: "center", marginBottom: 6 }}>
          ...
          {!editing && (
            ...
            >
              {getVisibility(field) === "private" ? "Private" : "Public"}
            </span>
          )}
        </div>
  ...
  return (
    <div style={{ display: "flex", marginTop: 70, padding: "0 24px", gap: 24 }}>
      <div style={{ flex: 2 }}>
        <div
          style={{
            padding: 16,
            ...
            border: `1px solid ${UI.border}`,
            borderRadius: UI.radius,
            background: `linear-gradient(140deg, ${UI.bg}, rgba(255,0,0,0))`,
            boxShadow: "0 8px 24px rgba(0,0,0,0.25)",
          }}
        >
          {/* Header */}
          <div style={{ display: "flex", alignItems: "center", marginBottom: 10 }}>
            <h2 style={{ margin: 0, fontSize: 22, color: UI.accent }}>Profile Card</h2>
                ...
                renderEdit={() => (
                  <div style={{ display: "grid", gridTemplateColumns: "1.3fr 2.7fr", gap: UI.gap }}>
                    <Select
                      ...
                      styles={{ control: (base) => ({ ...base, minHeight: UI.inputH, background: UI.bgSoft }) }}
                    />
                    <input
                      type="tel"
                      value={phoneNumber}
              ...
              <FieldRow
                ...
                renderEdit={() => (
                  <textarea
                    ...
                    style={{ ...inputBase, height: 88, padding: 10, resize: "vertical" }}
                  />
                )}
              />
          ...
          {/* Footer */}
          <div style={{ marginTop: 14, color: UI.accent, fontSize: 16 }}>
